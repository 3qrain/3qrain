...
import { Bold, Italic, Strikethrough, Code, Link as LinkIcon, Heading1, Heading2 } from '@lucide/vue'
...
<template>
  <BubbleMenu class="menu" :editor="props.editor" :options="{ placement: 'top-start' }" :append-to="bodyDom">
